# Generated by Powerlevel10k configuration wizard on 2022-01-23 at 14:11 CST.
...
# 12h time, vertical separators, blurred heads, flat tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M:%S %p}'
